package io.github.emtest.application.config;

import io.github.emtest.application.config.oauth2.MongoDBApprovalStore;
import io.github.emtest.application.config.oauth2.MongoDBAuthorizationCodeServices;
import io.github.emtest.application.config.oauth2.MongoDBClientDetailsService;
import io.github.emtest.application.config.oauth2.MongoDBTokenStore;
import io.github.emtest.application.repository.*;
...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("res_EmTest").tokenStore(tokenStore);
        }
    }
