package io.github.emtest.application.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    public void addOAuthClientDetails(MongoTemplate mongoTemplate) {
        ...
        appDetails.setClientId("EmTestapp");
        appDetails.setClientSecret("my-secret-token-to-change-in-production");
        appDetails.setResourceIds(Collections.singletonList("res_EmTest"));
        ...
        swaggerUIDetails.setResourceIds(Collections.singletonList("res_EmTest"));
